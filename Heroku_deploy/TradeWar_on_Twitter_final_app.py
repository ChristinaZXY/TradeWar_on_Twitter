...
markdown_text = ['Years of trade tensions between the world\'s two biggest economies have taken a worse turn since the start of 2018. ' \
                ...
                'Four panels below plotted together the market index daily close values (red) and the daily counts of tweets mentioning "trade war" (blue), for four different market indexes. ' \
